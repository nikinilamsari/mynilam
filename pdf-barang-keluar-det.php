            ...
            <thead>
                <tr>
                    <td class="bold judul2 tengah">
                        DETAIL LAPORAN PENDATAAN BARANG KELUAR
                    </td>
                </tr>
                <tr>
                    <td class="bold judul2 tengah">
                        KETERANGAN LAMPIRAN BARANG
                    </td>
                </tr>
                <tr>
                    <td class="bold judul2 tengah">
        ...
        <table>
            <thead>
                <tr class="awal-sub">
                    ...
                    <th colspan="2" style="width:250px ;">Detail Data Barang Keluar</th>
                </tr>
            </thead>
        </table>
    </div>
        ...
        <table class="data-keluarga" id="data-keluarga">
            <thead>
                <tr class="awal-sub judul2" style="background-color: darkgray;">
                    ...
                    <th class="b-atas" style="width: 250px;">Kode Barang Keluar</th>
                    <th class="b-ayah-ibu-atas">Nama Barang</th>
                    <th class="b-ayah-ibu-atas">Jumlah</th>
                ...
                $pkb =  cari_array($conn, 'SELECT * FROM tb_barangkeluar a INNER JOIN tb_detkeluar b ON a.kode_barangkeluar=b.kode_barangkeluar INNER JOIN tb_barang c ON b.id_barang=c.id_barang');
                $no = 0;
                foreach ($pkb as $pk) :
                    $no++;
                ?>
                    <tr class="awal-sub" style="border: 1px solid black;">
                        ...
                        <td class='b-ortu'><?= $pk['kode_barangkeluar'] ?></td>
                        <td class="b-ortus"><?= $pk['nama_barang'] ?></td>
                        <td class="b-ayah-ibu"><?= $pk['jumlah_keluar'] ?></td>
