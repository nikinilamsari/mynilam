            ...
            <thead>
                <tr>
                    <td class="bold judul2 tengah">
                        LAPORAN PENDATAAN STOK BARANG GUDANG
                    </td>
                </tr>
                <tr>
                    <td class="bold judul2 tengah">
        ...
        <table>
            <thead>
                <tr class="awal-sub">
                    ...
                    <th colspan="2" style="width:250px ;">Data Stok Barang</th>
                </tr>
            </thead>
        </table>
    </div>
        ...
        <table class="data-keluarga" id="data-keluarga">
            <thead>
                <tr class="awal-sub judul2" style="background-color: darkgray;">
                    ...
                    <th class="b-atas" style="width: 250px;">Kode Barang</th>
                ...
                $pkb =  cari_array($conn, 'SELECT * FROM tb_barang');
                $no = 0;
                foreach ($pkb as $pk) :
                    $no++;
                    $sqljum = "SELECT IF(jumlah_masuk,SUM(jumlah_masuk),0) as jml,IF(jumlah_keluar,SUM(jumlah_keluar),0) as kur FROM tb_detmasuk a JOIN tb_detkeluar b WHERE a.id_barang='$pk[id_barang]'";
                ...
                ?>
                    <tr class="awal-sub" style="border: 1px solid black;">
                        ...
                        <td class='b-ortu'><?= $pk['kode_barang'] ?></td>
                        <td class="b-ortus"><?= $pk['nama_barang'] ?></td>
                        <td class="b-ayah-ibu"><?= $sqljums['jml'] - $sqljums['kur'] ?></td>
                    </tr>
                <?php
                endforeach;
                ?>
