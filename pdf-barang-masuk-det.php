            ...
            <thead>
                <tr>
                    <td class="bold judul2 tengah">
                        DETAIL LAPORAN PENDATAAN BARANG MASUK
                    </td>
                </tr>
                <tr>
                    <td class="bold judul2 tengah">
        ...
        <table>
            <thead>
                <tr class="awal-sub">
                    ...
                    <th colspan="2" style="width:250px ;">Detail Data Barang Masuk</th>
                </tr>
            </thead>
        </table>
    </div>
    <div class="row awal2">
        <table class="data-keluarga" id="data-keluarga">
            <thead>
                ...
                $pkb =  cari_array($conn, 'SELECT * FROM tb_barangmasuk a INNER JOIN tb_detmasuk b ON a.kode_barangmasuk=b.kode_barangmasuk INNER JOIN tb_barang c ON b.id_barang=c.id_barang INNER JOIN tb_supplier d ON a.id_supplier=d.id_supplier');
                $no = 0;
                foreach ($pkb as $pk) :
                    $no++;
                ?>
                    <tr class="awal-sub" style="border: 1px solid black;">
                        ...
                        <td class="b-ayah-ibu"><?= $pk['jumlah_masuk'] ?></td>
