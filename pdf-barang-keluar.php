...
<body onload="js:window.print()">
        ...
        <table>
            <thead>
                <tr class="awal-sub">
                    ...
                    <th colspan="2" style="width:250px ;">Data Barang Keluar</th>
                </tr>
            </thead>
        </table>
    </div>
    <div class="row awal2">
        <table class="data-keluarga" id="data-keluarga">
            <thead>
                ...
                $pkb =  cari_array($conn, 'SELECT * FROM tb_barangkeluar ');
                $no = 0;
                foreach ($pkb as $pk) :
                    $no++;
                ?>
                    <tr class="awal-sub" style="border: 1px solid black;">
                        ...
                        <td class="b-ayah-ibu"><?= $pk['tgl_barangkeluar'] ?></td>
                    </tr>
                <?php
                endforeach;
                ?>
    ...
    <div class="row awal1">
        <table>
            <thead>
                <tr>
                    <td colspan="5">*Lampiran detail barang keluar di cetak di lembar selanjutnya.</td>
